...
class Saturday implements DateConditionInterface
{
    ...
    {
        return $interval->d >= 2 && $interval->d <= 6 && $date->format('N') == 6;
    }

    public function getSemanticRepresentation(DateTime $date, DateInterval $interval): string
    {
        return $this->translator->translate('conditionals.saturday');
    }
}
